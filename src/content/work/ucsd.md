...
- Traced silent training failures across the stack including LoRA injection failing due to `ReplicatedLinear` vs `nn.Linear`, VAE config overwriting by Wan-specific defaults, and hardcoded CFG dropout shape.
